...
class CFMRun:
    def __init__(self, borehole_lat: float, borehole_lon: float, physRho: str) -> None:
        ...
        self._json_config_name = f"CFMconfig_{borehole_lat}_{borehole_lon}_{config['start_year']}_{config['end_year']}_{self._cfm_config['physRho']}_spin{config['spin_end_year']}_reps{config['num_reps']}.json"
        ...
        self._cfm_config["resultsFolder"] = (
            f"{self._cfm_output_path}/CFMoutput_{self._cfm_config['borehole_lat']}_{self._cfm_config['borehole_lon']}_{config['start_year']}_{config['end_year']}_{self._cfm_config['physRho']}_spin{config['spin_end_year']}_reps{config['num_reps']}"
        )
